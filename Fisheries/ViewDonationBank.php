                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">View BOD Approved Donations</h4>
                                    ...
                                    <div class="table-responsive pt-3">
                                        <table class="table table-dark">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * FROM approval_donations where Status='BOD Approved'";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <Button><a href='ViewDonationProfileToApprove.php?id=<?php echo $record['DonationID'] ?>'>Pass Donation</a></Button>
                                                        </td>
