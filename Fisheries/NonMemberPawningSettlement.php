...
if (isset($_POST['searchamount'])) {
    ...
    $sql13 =  "SELECT COUNT(*) as CountPawning FROM non_mem_pass_pawnings WHERE pawningID= '$pawningID' AND AccountNo= '$AccountNo' AND NIC= '$NIC' ";
    ...
    if ($CountPawning > 0) {
        $sql11 =  "SELECT SUM(PayAmount) as AmountPaid FROM nonmem_pawning_settlement WHERE pawningID= '$pawningID '";
        ...
        $sql16 =  "SELECT SUM(TotalPay) as TotalPay FROM nonmem_pawning_settlement WHERE pawningID= '$pawningID '";
        ...
        $sql28 =  "SELECT SUM(InterestAmount) as InterestAmount FROM nonmem_pawning_settlement WHERE pawningID= '$pawningID'";
        ...
        $sql13 =  "SELECT COUNT(PayAmount) as SettleCount FROM nonmem_pawning_settlement WHERE pawningID= '$pawningID '";
        $resultset13 = mysqli_query($conn, $sql13) or die("database error:" . mysqli_error($conn));
        $data13 = mysqli_fetch_assoc($resultset13);
        $SettleCount = $data13['SettleCount'];


        $sql12 = "SELECT * FROM non_mem_pass_pawnings WHERE pawningID= '$pawningID '";
        ...
        $sql14 =  "SELECT MAX(Settle_ID) as GetSettle_ID FROM nonmem_pawning_settlement WHERE pawningID= '$pawningID '";
        ...
        $sql15 =  "SELECT * FROM nonmem_pawning_settlement WHERE Settle_ID= '$MaxSettle_ID '";
...
if (isset($_POST['createPawningSettlement'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql27 =  "SELECT SUM(TotalPay) as TotalPay FROM nonmem_pawning_settlement WHERE pawningID= '$pawningID'";
        ...
        $sql26 =  "SELECT SUM(InterestAmount) as InterestAmount FROM nonmem_pawning_settlement WHERE pawningID= '$pawningID'";
        ...
        $sql23 = "SELECT * FROM non_mem_pass_pawnings WHERE pawningID= '$pawningID '";
        ...
        if (($TotalPaidAmount + $SettleAmount) >= $pawningamount) {
            ...
            $update1 = "UPDATE nonmem_pawning_settlement SET Status='$Status' where pawningID='$pawningID'";
            ...
            if ($AddAmount != 0) {
                ...
                $sql = "insert into nonmem_pawning_settlement(NIC,AccountNo,pawningID,PayAmount,InterestAmount,TotalPay,RemainAmount,PayDate,LastPaymentDate,Status) values('$NIC','$AccountNo','$pawningID','$PayAmount','$InterestAmount','$lastSettlementAmount','$remainingAmount','$payDate','$LastPaymentDate','$Status')";


                $TransactionType = "Credit";

                $sql3 = "SELECT SUM(Amount) as TotalAmount FROM non_member_transactions WHERE AccNo= '$AccountNo ' AND TransType='Credit'";
                ...
                $sql4 = "SELECT SUM(Amount) as TotalAmount FROM non_member_transactions WHERE AccNo= '$AccountNo ' AND TransType='Debit'";
                ...
                $Name = "Non-Member Pawning Settlement";

                $sql3 = "insert into non_member_transactions(NIC,AccNo,TransType,Amount,RunningBal,Description,FullName) values('$NIC','$AccountNo','$TransactionType','$AddAmount','$NewBalance','$Description','$Name')";
            ...
            $Status = "Pending";
            $sql = "insert into nonmem_pawning_settlement(NIC,AccountNo,pawningID,PayAmount,InterestAmount,TotalPay,RemainAmount,PayDate,LastPaymentDate,Status) values('$NIC','$AccountNo','$pawningID','$PayAmount','$InterestAmount','$TotWithIntAmount','$remainingAmount','$payDate','$LastPaymentDate','$Status')";
        }
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Non-Member Pawning Settlement</h3>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" class="form-control" name="NIC" value="<?php echo isset($_POST['NIC']) ? $_POST['NIC'] : '' ?>" required/>
                                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" class="form-control" name="PawningCreatedDate" id="PawningCreatedDate" value="<?php echo $PawningCreatedDate; ?>"required readonly />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" class="form-control" name="TotWithIntAmount" id="Amount" value="<?php echo $TotalPay; ?>"required readonly />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col">
                                                                <button class="btn btn-warning" type="button" id="calculate" onclick="Calculate2();"> Generate Amount</button>
                ...
                <script type="text/javascript">
                    function Calculate2() {
                        ...
                        if (SettleCount == 0) {
                            ...
                            if (daydiff <= 30) {
                                var InterestAmount = ((Amount * 20) / 100) / 12;
                                var totalwithInterest = SettleAmount + InterestAmount;
                            } else {
                                var InterestAmount = (((Amount * 20) / 100) / 365) * daydiff;
                                var totalwithInterest = SettleAmount + InterestAmount;
                            ...
                            var InterestAmount = (((remainAmount * 20) / 100) / 365) * daydiff;
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">View Non Member Pawning Settlements</h4><Br>
                                        ...
                                        <table class="table table-dark">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_POST['searchaccount'])) {
                                                    ...
                                                    $accNo = $_POST['accNo'];
                                                    $sql = "SELECT * FROM nonmem_pawning_settlement where pawningID='$accNo'";
