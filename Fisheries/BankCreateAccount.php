    ...
    <div class="container-scroller">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Type of create account</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" name="empType" id="accountType">
                                                <option value="1">Member Account</option>
                                                <option value="2">Non Member Account For Pawning</option>
                                                <option value="3">Employee Account</option>
        ...
        <script type="text/javascript">
            ...
            function Openform() {
                ...
                if (output == "1") {
                    window.location.href = 'CreateAccountMember.php';

                } else if (output == "2") {
                    window.location.href = 'CreateAccountNonMember.php';

                } else if (output == "3") {
                    window.location.href = 'CreateAccountEmployee.php';

                } else if (output == "4") {
                    window.location.href = 'CreateAccountMemberDependant.php';
