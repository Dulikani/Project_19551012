                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Process Loans</h3>
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">select the process type</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" name="accountType" id="accountType">
                                                <option value="1">View Loans</option>
                                                <option value="3">Update Interest</option>
                                                <option value="4">Loan Issued</option>
                                                <option value="5">Loan Settlement</option>
    ...
    <script type="text/javascript">
        function Openform() {
            ...
            if (output == "1") {
                ...
                window.location.href = 'ViewLoansBank.php';

            } else if (output == "3") {

                window.location.href = 'UpdateInterest.php';


            } else if (output == "4") {


                window.location.href = 'IssuedLoansBank.php';

            } else if (output == "5") {

                window.location.href = 'LoanSettlement.php';
