        ...
        <div class="container-fluid page-body-wrapper">
            ...
            if (isset($_POST['savechanges'])) {
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $update = "UPDATE member SET nic='$NIC',first_name='$fname',last_name='$lname',gender='$gender',birthdate='$newDate',age='$age',contact_no=$telephone,addres='$address' where member_id='$member_id'";
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <form class="form-sample" action="" method="POST">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label">Enter Member ID</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="memberID" id="memberID" class="form-control" value="<?php echo isset($_POST['memberID']) ? $_POST['memberID'] : '' ?>" /><br>
                                                        <button type="submit" name="search" class="btn btn-warning mr-2">Search Member</button>
                                                        <hr>
                                                    </div>
                                                </div>
                                            </form>
                                    ...
                                    ?>
                                                ...
                                                <form class="form-sample" action="" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" name="fname" id="firstname" value="<?php echo $record['first_name']; ?>" readonly required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" name="lname" id="lastname" value="<?php echo $record['last_name']; ?>" readonly required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="date" data-date-format="DD-MM-YYYY" class="form-control"  name="dob" id="dob" value="<?php echo $dobNew;  ?>" readonly required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <input type="text" name="member_id" id="member_id" value="<?php echo $record['member_id']; ?>" hidden />
                                                ...
                                                <br><br>
                                                <button type="" class="btn btn-primary mr-2" id="myButton1">Edit</button>

                                                <button type="" class="btn btn-success mr-2" id="AddDependant1"><a href='AddMemberDependant.php?memid=<?php echo $record['member_id'] ?>' style="color:white;">Add/View Dependant</a></button>
                                    <?php } else {
                                    ...
                                    <script>
                                        document.getElementById('myButton1').onclick = function() {
                                            ...
                                            var btn3 = document.getElementById('AddDependant1');
                                            btn3.disabled = true;
                                        };
                                    </script>
