...
if (isset($_POST['pass'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $description = "Non Member Pawning";
        ...
        if ($RunningBal > $pawningamount) {
            $sql = "insert into non_mem_pass_pawnings(NIC,AccountNo,Interest,PawningCreatedDate,settlementDate,totalWeight,pawningamount,amount,ApprovedBy) values('$NIC','$AccountNo','$Interest','$todate','$settlementDate','$totalWeight','$pawningamount','$amount','$ApprovedBy')";
            ...
            if ($check == 1) {
                ...
                $sql12 = "SELECT SUM(Amount) as SumCreditAcc FROM non_member_transactions where TransType='Credit' AND AccNo='$AccountNo'";
                ...
                $sql13 = "SELECT SUM(Amount) as SumDebitAcc FROM non_member_transactions where TransType='Debit' AND AccNo='$AccountNo'";
                ...
                $Name = "Fisheries Non Mem Pawning";

                $sql11 = "insert into non_member_transactions(NIC,AccNo,TransType,Amount,RunningBal,Description,FullName) values('$NIC','$AccountNo','$transerTypeCR','$pawningamount','$RunningBalMem','$description','$Name')";
...
?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample" action="" id="memberAccount" method="POST" target="_parent">
                                        <h4 class="">Non Member Pawning Creation<br></h4><br>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" class="form-control" name="NIC" id="NIC" value="<?php echo isset($_POST['NIC']) ? $_POST['NIC'] : '' ?>" />
                                                            </div>
                                            ...
                                            if (isset($_POST['searchmember'])) {
                                                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                                    ...
                                                    $sql = "SELECT * FROM non_member_account WHERE NIC= '$valueToSearch '";
                                                                    ...
                                                                    ?>
                                                                        <option value="<?php echo $record["account_No"]; ?>">
                                                                            <?php echo $record["account_No"]; ?> - LKR <?php
                                                                                                                        ...
                                                                                                                        $sql3 = "SELECT SUM(Amount) as TotalAmount FROM non_member_transactions WHERE AccNo= '$AcNo ' AND TransType='Credit'";
                                                                                                                        ...
                                                                                                                        $sql4 = "SELECT SUM(Amount) as TotalAmount FROM non_member_transactions WHERE AccNo= '$AcNo ' AND TransType='Debit'";
    ...
    <script type="text/javascript">
        function Calculate() {
            ...
            var repaymentInterest = (weightAmount * 20) / 100;
