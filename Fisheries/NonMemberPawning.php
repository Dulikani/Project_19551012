                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Non - Member Pawning</h3>
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">select the process type</label>
                                            <div class="col-sm-9">
                                                <select class="form-control" name="accountType" id="accountType">
                                                    <option value="1">Insert Pawning</option>
                                                    <option value="2">Manage Pawning</option>
                                                    <option value="4">Settle Pawning</option>
    ...
    <script type="text/javascript">
        ...
        function Openform() {
            ...
            if (output == "1") {
                ...
                window.location.href = 'NonMemberInsertPawning.php';

            } else if (output == "2") {
               
                window.location.href = 'NonMemberManagePawning.php';

            }  else if (output == "4") {
               

                window.location.href = 'NonMemberPawningSettlement.php';
             } 
