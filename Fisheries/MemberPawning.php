                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Member Pawning</h3>
    ...
    <script type="text/javascript">
        function Openform() {
            ...
            if (output == "1") {
                ...
                window.location.href = 'InsertPawning.php';

            } else if (output == "2") {

                window.location.href = 'ManagePawnings.php';

            } else if (output == "4") {


                window.location.href = 'PawningSettlement.php';
            }
