...
if (isset($_POST['createemployeeaccount'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql1 = "SELECT COUNT(*) AS TypeCount FROM employee_account WHERE emp_ID='$empID' and AccType='$AccountType'";
        ...
        if ($type == 0) {
            $sql = "insert into employee_account(emp_ID,NIC,AccType,TransType,OpeningBal,TransAmount,TransDate,CreatedBy) values('$empID','$NIC','$AccountType','$TransactionType','$transactionAmount','$transactionAmount','$transactionDateNew','$createdBy')";
                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample" action="" method="POST" id="employeeAccount" target="_parent">
                                        <h4 class="">Employee Account Creation<br></h4><br>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="text" class="form-control" name="empID" value="<?php echo isset($_POST['empID']) ? $_POST['empID'] : '' ?>" />
                                                            </div>
                                            ...
                                            ?>
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" name="NIC" value="<?php echo $record['nic']; ?>" readonly />
                                                                </div>
                                                            </div>
                                                        </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="fname" value="<?php echo $record['first_name']; ?>" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="lname" value="<?php echo $record['last_name']; ?>" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary mr-2" name="createemployeeaccount">Create Account</button>
                                ...
                                <div class="table-responsive pt-3">
                                    ...
                                    <table class="table table-dark">
                                        ...
                                        <tbody>
                                            <?php
                                                        $sql = "SELECT * FROM employee_account WHERE emp_ID='$valueToSearch'";
                                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
