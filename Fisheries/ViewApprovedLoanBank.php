                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <Button><a href='sendBODUpdate.php?id=<?php echo $record['LoanID'] ?>'>Send To BOD</a></Button>
                                                        </td>
                                                        <td>

                                                            <Button><a href='ViewLoanPRofile.php?id=<?php echo $record['LoanID'] ?>'>View Loan</a></Button>
                                                        </td>
