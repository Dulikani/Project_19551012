                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">View Pending Loans</h4>
                                    ...
                                    <div class="table-responsive pt-3">
                                        <table class="table table-dark">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * FROM member_loan where Approval='Sent BOD'";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <Button class="badge badge-primary"><a style="color:white;" href='ViewLoanProfileToApproveBOD.php?id=<?php echo $record['LoanID'] ?>'>View Loan</a></Button>
                                                        </td>
